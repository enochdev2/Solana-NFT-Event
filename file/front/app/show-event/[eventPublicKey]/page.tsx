         ...
         <div className=" w-screen px-3 min-h-screen mb-10">
            <div className="md:flex items-center h-full gap-4  justify-evenly">
                <div className="max-w-md w-full space-y-8 p-10 mt-3 bg-gradient-to-tl from-[#092338] to-[#2b0416] rounded-xl shadow-md">
                    {eventDetails && (
                        <div className="mb-6">
                            <h1 className="text-center text-4xl font-extrabold bg-gradient-to-br from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] text-transparent bg-clip-text mb-3">{eventDetails.title}</h1>
            ...
            {tickets.length > 0 && (
                <div className="mt-8 py-6 bg-gradient-to-tl from-[#092338] to-[#2b0416] rounded-lg">
                    <h3 className="text-center text-2xl font-extrabold bg-gradient-to-br from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] text-transparent bg-clip-text">Tickets purchased for this event :</h3>
                    <ul>

        ...
        <Layout>
            <div className="flex flex-col md:flex-row items-start justify-between px-8 text-white">
                ...
                <div className=" relative hidden lg:block md:w-1/2 p-4 h-[100vh] ">
                    <Image src="/nft.png" fill alt="NFT Event" className="w-full  rounded-lg shadow-md" />
                </div>
                ...
                <div className=" w-[98%] md:max-w-3xl lg:max-w-md mx-auto p-4 mt-5  shadow-md rounded-lg flex-1 bg-gradient-to-r from-[#eb0ebf] via-[#e21c1c] to-[#9206f7] backdrop-blur-lg">
                    <div className=" w-[98%] lg:max-w-md mx-auto p-4 my-5 bg-black/70 text-white shadow-md rounded-lg flex-1">
                        ...
                        >
                            <div>
                                <label className="block text-sm font-medium text-gray-100" htmlFor="title">
                                    Title
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-100" htmlFor="date">
                                    Date
                                </label>
                                <input
                                    type="date"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-100" htmlFor="location">
                                    Location
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-100" htmlFor="ticketPrice">
                                    Ticket Price (in SOL)
                                </label>
                                <input
                                    type="number"

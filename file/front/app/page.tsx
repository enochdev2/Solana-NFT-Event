        ...
        <Layout>
            <section className=" bg-[url('/herobg.png')]">
                ...
                <div className="flex flex-col py-8 items-center justify-center ">
                    <h1 className="text-3xl md:text-5xl font-extrabold bg-gradient-to-br from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] text-transparent bg-clip-text mb-4">
                        Welcome to our events and NFTs platform.
                    </h1>
                    <p className="text-base md:text-xl text-gray-100 px-2 mb-8 text-center max-w-2xl">
                        Our platform, built on the Solana blockchain, allows event organizers to create unique events and sell tickets as NFTs. Using the Solana
                        blockchain, our platform enables event organizers to mint unique events and sell tickets as non-fungible tokens.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        <div className="bg-gradient-to-r from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] rounded-lg shadow-lg p-6 max-w-xs">
                            ...
                            <p className="text-gray-100 mb-4  bg-black/20  w-full rounded-md">
                                Organize your events in just a few clicks and make them available to your audience. Set up your events in seconds and share them
                                with your community.
                            </p>
                            <Link
                                href="/create-event"
                        ...
                        <div className="bg-gradient-to-r from-[#ffafaf] via-[#0489f5a6] to-[#c374f7]  rounded-lg flex-col flex justify-between shadow-lg p-6 max-w-xs">
                            ...
                            <p className="text-gray-100 mb-4 bg-black/20  w-full rounded-md">
                                Explore all available events and join the ones you&apos;re interested in.
                            </p>
                            <Link
                                href="/list-events"
                                className="block text-center py-2 px-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300"
                    ...
                    <div className="mt-12 text-center">
                        <h2 className="text-3xl font-bold bg-gradient-to-br from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] text-transparent bg-clip-text mb-4">
                            Join us now!
                        </h2>
                        ...
                        <Link
                            href="/create-event"
                            className="inline-block py-3 px-6 bg-gradient-to-br from-[#ffafaf] via-[#0489f5a6] to-[#c374f7] text-2xl text-white rounded-lg hover:bg-indigo-700 transition font-bold duration-300"
                        >
                            Start
                        </Link>
                    </div>
